        ...
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-2 flex-1">
            <div className="flex items-center gap-2 flex-wrap">
              <h3 className="font-semibold sm:text-lg">{fn.name}</h3>
          ...
          <div className="text-right">
            <div className="text-xl sm:text-2xl font-bold text-neutral-500">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2 bg-muted/50 rounded p-2">
            ...
            <Button
              ...
              onClick={() => copyToClipboard(fn.id, fn.id)}
            >
              {copiedId === fn.id ? (
    ...
    <div className="pb-12">
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Main Content */}
          <div className="flex-1 lg:basis-2/3 space-y-8">
            {/* Summary Card */}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="font-semibold">
                      {results.primaryFunctions.length +
                        results.secondaryFunctions.length}
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            {embeddingFeatures && (
              <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-900">
                <CardHeader className="px-4 sm:px-6">
                  ...
                  <CardDescription>
                    Deep learning embeddings for structural and functional
                    insights
                  </CardDescription>
                </CardHeader>
                ...
                <CardContent className="space-y-6 px-4 sm:px-6">
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    <div className="space-y-2">
                      ...
                      <p className="font-semibold">
                        {embeddingStats?.dimension || 1280}
                      </p>

                      <p className="text-xs text-muted-foreground">
                        Layer {embeddingStats?.layer || 12}
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="font-semibold">
                        {embeddingFeatures.dynamicRange.toFixed(3)}
                      </p>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex-1 bg-blue-200 dark:bg-blue-900 rounded-full h-2 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min(
                              embeddingFeatures.complexity * 100,
                              100
                            )}%`,
                          }}
                        />
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-end justify-between gap-1 bg-muted/30 rounded p-3">
                      {embeddingFeatures.regions.map(
                    ...
                    <p className="text-xs text-muted-foreground">
                      Distribution across 10 regions of embedding space
                    </p>
                  </div>
                  ...
                  <div className="pt-3 border-t border-border space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      ...
                      <div className="bg-muted/50 rounded p-2">
                        ...
                        <p className="font-mono font-semibold">
                          {embeddingStats?.range[0].toFixed(3)}
                        </p>
                      </div>
                      ...
                      <div className="bg-muted/50 rounded p-2">
                        ...
                        <p className="font-mono font-semibold">
                          {embeddingStats?.range[1].toFixed(3)}
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <Tabs defaultValue="primary" className="w-full">
              <TabsList className="flex w-full justify-start">
                <TabsTrigger value="primary">
                  Primary Functions ({results.primaryFunctions.length})
                </TabsTrigger>

                <TabsTrigger value="secondary">
                  Secondary Functions ({results.secondaryFunctions.length})
                </TabsTrigger>
              </TabsList>
                ...
                {results.primaryFunctions.length > 0 ? (
                  <>
                    <p className="text-sm text-muted-foreground">
                      Primary functional categories with highest confidence
                      scores
                    </p>
                  ...
                  <Card className="border-border">
                    <CardContent className="pt-6 text-center text-muted-foreground px-4 sm:px-6">
              ...
              <TabsContent value="secondary" className="space-y-4">
                {results.secondaryFunctions.length > 0 ? (
                  <>
                    <p className="text-sm text-muted-foreground">
                      Secondary or contextual functional predictions with
                      moderate confidence
                    </p>
            ...
            <Card className="border-border bg-muted/30">
              <CardHeader>
                ...
                <CardDescription>
                  Learn about the classification framework used in this analysis
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Describes what the protein does at the biochemical level
                    (e.g., catalysis, binding)
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Describes the larger biological goals the protein
                    contributes to (e.g., metabolism, cell cycle)
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Describes where in the cell the protein is located or
                    functions (e.g., nucleus, membrane)
                  </p>
                </div>
                ...
                <div className="pt-3 border-t border-border">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-neutral-500 hover:underline text-xs font-medium flex items-center gap-1"
                  >
