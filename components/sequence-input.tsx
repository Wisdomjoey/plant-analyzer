...
export function SequenceInput() {
  const [inputType, setInputType] = useState<"sequence" | "uniprot">(
    "sequence"
  );
  ...
  const isInputValid =
    (inputType === "sequence" && sequenceInput.trim()) ||
    (inputType === "uniprot" && uniprotId.trim());
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-sm sm:text-base text-muted-foreground">
            Input your protein sequence or UniProt ID for functional
            classification
          </p>
        </div>
        ...
        {error && (
          <Card className="border-destructive bg-destructive/5">
            <CardContent className="flex gap-3 px-4 sm:px-6">
        ...
        <Card className="border-border">
          <CardHeader className="px-4 sm:px-6">
            ...
            <CardDescription>
              Choose how you want to provide your protein data
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6 px-4 sm:px-6">
            <Tabs
              value={inputType}
              onValueChange={(v) => setInputType(v as "sequence" | "uniprot")}
            >
              ...
              <TabsContent value="sequence" className="space-y-4">
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    placeholder="Enter protein sequence in single or three-letter code (e.g., MVHLTPE...) Or paste a FASTA format sequence"
              ...
              <TabsContent value="uniprot" className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Enter a valid UniProt accession number to automatically
                    fetch the sequence and metadata
                  </p>
                </div>
              </TabsContent>
            </Tabs>
        ...
        <Card className="border-border bg-muted/30">
          ...
          <CardContent className="text-sm text-muted-foreground space-y-2 px-4 sm:px-6">
            <p>
              1. <strong>Input</strong> your protein sequence or UniProt
              identifier
            </p>

            <p>
              2. <strong>Fetch</strong> curated metadata and annotations from
              UniProt
            </p>

            <p>
              3. <strong>Process</strong> using ESM-2 or ProtT5 pre-trained
              models
            </p>

            <p>
              4. <strong>Classify</strong> into Gene Ontology functional
              categories
            </p>

            <p>
              5. <strong>Explore</strong> detailed annotations and biological
              context
            </p>
          </CardContent>
        </Card>
